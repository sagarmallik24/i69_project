...
class Reported_Users(models.Model):
    ...
    reporter = models.ForeignKey('user.User', related_name="reported_list", on_delete=models.SET_NULL, null=True)
    reportee = models.ForeignKey('user.User', related_name='reports', on_delete=models.SET_NULL, null=True)
