...
from defaultPicker.utils import language_translate
...
class gender(models.Model):
    ...
    gender_es_419 = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    gender_br = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    gender_nn = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
...
class Language(models.Model):
    ...
    def __str__(self):
        return str(self.id) + ' - ' + str(self.language) + ' - ' + str(self.language_code)
...
class searchGender(models.Model):
    ...
    searchGender_es_419 = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    searchGender_br = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    searchGender_nn = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    def save(self, *args, **kwargs):
        self.searchGender_fr = language_translate(self.searchGender_fr, self.searchGender, "fr")
        self.searchGender_zh_cn = language_translate(self.searchGender_zh_tw, self.searchGender, "zh-cn")
        self.searchGender_nl = language_translate(self.searchGender_nl, self.searchGender, "nl")
        self.searchGender_de = language_translate(self.searchGender_de, self.searchGender, "de")
        self.searchGender_sw = language_translate(self.searchGender_sw, self.searchGender, "sw")
        self.searchGender_it = language_translate(self.searchGender_it, self.searchGender, "it")
        self.searchGender_ar = language_translate(self.searchGender_ar, self.searchGender, "ar")
        self.searchGender_iw = language_translate(self.searchGender_iw, self.searchGender, "iw")
        self.searchGender_ja = language_translate(self.searchGender_ja, self.searchGender, "ja")
        self.searchGender_ru = language_translate(self.searchGender_ru, self.searchGender, "ru")
        self.searchGender_fa = language_translate(self.searchGender_fa, self.searchGender, "fa")
        self.searchGender_pt_br = language_translate(self.searchGender_pt_br, self.searchGender, "pt_br")
        self.searchGender_pt_pt = language_translate(self.searchGender_pt_pt, self.searchGender, "pt_pt")
        self.searchGender_es = language_translate(self.searchGender_es, self.searchGender, "es")
        self.searchGender_el = language_translate(self.searchGender_el, self.searchGender, "el")
        self.searchGender_zh_tw = language_translate(self.searchGender_zh_tw, self.searchGender, "zh-tw")
        self.searchGender_uk = language_translate(self.searchGender_uk, self.searchGender, "uk")
        self.searchGender_ko = language_translate(self.searchGender_ko, self.searchGender, "ko")
        self.searchGender_pl = language_translate(self.searchGender_pl, self.searchGender, "pl")
        self.searchGender_vi = language_translate(self.searchGender_vi, self.searchGender, "vi")
        self.searchGender_no = language_translate(self.searchGender_no, self.searchGender, "no")
        self.searchGender_sv = language_translate(self.searchGender_sv, self.searchGender, "sv")
        self.searchGender_hr = language_translate(self.searchGender_hr, self.searchGender, "hr")
        self.searchGender_cs = language_translate(self.searchGender_cs, self.searchGender, "cs")
        self.searchGender_da = language_translate(self.searchGender_da, self.searchGender, "da")
        self.searchGender_tl = language_translate(self.searchGender_tl, self.searchGender, "tl")
        self.searchGender_fi = language_translate(self.searchGender_fi, self.searchGender, "fi")
        self.searchGender_sl = language_translate(self.searchGender_sl, self.searchGender, "sl")
        self.searchGender_sq = language_translate(self.searchGender_sq, self.searchGender, "sq")
        self.searchGender_am = language_translate(self.searchGender_am, self.searchGender, "am")
        self.searchGender_hy = language_translate(self.searchGender_hy, self.searchGender, "hy")
        self.searchGender_la = language_translate(self.searchGender_la, self.searchGender, "la")
        self.searchGender_lv = language_translate(self.searchGender_lv, self.searchGender, "lv")
        self.searchGender_th = language_translate(self.searchGender_th, self.searchGender, "th")
        self.searchGender_az = language_translate(self.searchGender_az, self.searchGender, "az")
        self.searchGender_eu = language_translate(self.searchGender_eu, self.searchGender, "eu")
        self.searchGender_be = language_translate(self.searchGender_be, self.searchGender, "be")
        self.searchGender_bn = language_translate(self.searchGender_bn, self.searchGender, "bn")
        self.searchGender_bs = language_translate(self.searchGender_bs, self.searchGender, "bs")
        self.searchGender_bg = language_translate(self.searchGender_bg, self.searchGender, "bg")
        self.searchGender_km = language_translate(self.searchGender_km, self.searchGender, "km")
        self.searchGender_ca = language_translate(self.searchGender_ca, self.searchGender, "ca")
        self.searchGender_et = language_translate(self.searchGender_et, self.searchGender, "et")
        self.searchGender_gl = language_translate(self.searchGender_gl, self.searchGender, "gl")
        self.searchGender_ka = language_translate(self.searchGender_ka, self.searchGender, "ka")
        self.searchGender_hi = language_translate(self.searchGender_hi, self.searchGender, "hi")
        self.searchGender_hu = language_translate(self.searchGender_hu, self.searchGender, "hu")
        self.searchGender_is = language_translate(self.searchGender_is, self.searchGender, "is")
        self.searchGender_id = language_translate(self.searchGender_id, self.searchGender, "id")
        self.searchGender_ga = language_translate(self.searchGender_ga, self.searchGender, "ga")
        self.searchGender_mk = language_translate(self.searchGender_mk, self.searchGender, "mk")
        self.searchGender_mn = language_translate(self.searchGender_mn, self.searchGender, "mn")
        self.searchGender_ne = language_translate(self.searchGender_ne, self.searchGender, "ne")
        self.searchGender_ro = language_translate(self.searchGender_ro, self.searchGender, "ro")
        self.searchGender_sr = language_translate(self.searchGender_sr, self.searchGender, "sr")
        self.searchGender_sk = language_translate(self.searchGender_sk, self.searchGender, "sk")
        self.searchGender_ta = language_translate(self.searchGender_ta, self.searchGender, "ta")
        self.searchGender_tg = language_translate(self.searchGender_tg, self.searchGender, "tg")
        self.searchGender_tr = language_translate(self.searchGender_tr, self.searchGender, "tr")
        self.searchGender_ur = language_translate(self.searchGender_ur, self.searchGender, "ur")
        self.searchGender_uz = language_translate(self.searchGender_uz, self.searchGender, "uz")
...
class ethnicity(models.Model):
    ...
    ethnicity_es_419 = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    ethnicity_br = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    ethnicity_nn = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    def save(self, *args, **kwargs):
        ...
        self.ethnicity_zh_cn = language_translate(self.ethnicity_zh_cn, self.ethnicity, "zh-cn")
        ...
        self.ethnicity_pt_br = language_translate(self.ethnicity_pt_br, self.ethnicity, "pt_br")
        self.ethnicity_pt_pt = language_translate(self.ethnicity_pt_pt, self.ethnicity, "pt_pt")
        ...
        self.ethnicity_zh_tw = language_translate(self.ethnicity_zh_tw, self.ethnicity, "zh-tw")
...
class family(models.Model):
    ...
    familyPlans_es_419 = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    familyPlans_br = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    familyPlans_nn = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    def save(self, *args, **kwargs):
        self.familyPlans_fr = language_translate(self.familyPlans_fr, self.familyPlans, "fr")
        self.familyPlans_zh_cn = language_translate(self.familyPlans_zh_cn, self.familyPlans, "zh-cn")
        self.familyPlans_nl = language_translate(self.familyPlans_nl, self.familyPlans, "nl")
        self.familyPlans_de = language_translate(self.familyPlans_de, self.familyPlans, "de")
        self.familyPlans_sw = language_translate(self.familyPlans_sw, self.familyPlans, "sw")
        self.familyPlans_it = language_translate(self.familyPlans_it, self.familyPlans, "it")
        self.familyPlans_ar = language_translate(self.familyPlans_ar, self.familyPlans, "ar")
        self.familyPlans_iw = language_translate(self.familyPlans_iw, self.familyPlans, "iw")
        self.familyPlans_ja = language_translate(self.familyPlans_ja, self.familyPlans, "ja")
        self.familyPlans_ru = language_translate(self.familyPlans_ru, self.familyPlans, "ru")
        self.familyPlans_fa = language_translate(self.familyPlans_fa, self.familyPlans, "fa")
        self.familyPlans_pt_br = language_translate(self.familyPlans_pt_br, self.familyPlans, "pt_br")
        self.familyPlans_pt_pt = language_translate(self.familyPlans_pt_pt, self.familyPlans, "pt_pt")
        self.familyPlans_es = language_translate(self.familyPlans_es, self.familyPlans, "es")
        self.familyPlans_el = language_translate(self.familyPlans_el, self.familyPlans, "el")
        self.familyPlans_zh_tw = language_translate(self.familyPlans_zh_tw, self.familyPlans, "zh-tw")
        self.familyPlans_uk = language_translate(self.familyPlans_uk, self.familyPlans, "uk")
        self.familyPlans_ko = language_translate(self.familyPlans_ko, self.familyPlans, "ko")
        self.familyPlans_pl = language_translate(self.familyPlans_pl, self.familyPlans, "pl")
        self.familyPlans_vi = language_translate(self.familyPlans_vi, self.familyPlans, "vi")
        self.familyPlans_no = language_translate(self.familyPlans_no, self.familyPlans, "no")
        self.familyPlans_sv = language_translate(self.familyPlans_sv, self.familyPlans, "sv")
        self.familyPlans_hr = language_translate(self.familyPlans_hr, self.familyPlans, "hr")
        self.familyPlans_cs = language_translate(self.familyPlans_cs, self.familyPlans, "cs")
        self.familyPlans_da = language_translate(self.familyPlans_da, self.familyPlans, "da")
        self.familyPlans_tl = language_translate(self.familyPlans_tl, self.familyPlans, "tl")
        self.familyPlans_fi = language_translate(self.familyPlans_fi, self.familyPlans, "fi")
        self.familyPlans_sl = language_translate(self.familyPlans_sl, self.familyPlans, "sl")
        self.familyPlans_sq = language_translate(self.familyPlans_sq, self.familyPlans, "sq")
        self.familyPlans_am = language_translate(self.familyPlans_am, self.familyPlans, "am")
        self.familyPlans_hy = language_translate(self.familyPlans_hy, self.familyPlans, "hy")
        self.familyPlans_la = language_translate(self.familyPlans_la, self.familyPlans, "la")
        self.familyPlans_lv = language_translate(self.familyPlans_lv, self.familyPlans, "lv")
        self.familyPlans_th = language_translate(self.familyPlans_th, self.familyPlans, "th")
        self.familyPlans_az = language_translate(self.familyPlans_az, self.familyPlans, "az")
        self.familyPlans_eu = language_translate(self.familyPlans_eu, self.familyPlans, "eu")
        self.familyPlans_be = language_translate(self.familyPlans_be, self.familyPlans, "be")
        self.familyPlans_bn = language_translate(self.familyPlans_bn, self.familyPlans, "bn")
        self.familyPlans_bs = language_translate(self.familyPlans_bs, self.familyPlans, "bs")
        self.familyPlans_bg = language_translate(self.familyPlans_bg, self.familyPlans, "bg")
        self.familyPlans_km = language_translate(self.familyPlans_km, self.familyPlans, "km")
        self.familyPlans_ca = language_translate(self.familyPlans_ca, self.familyPlans, "ca")
        self.familyPlans_et = language_translate(self.familyPlans_et, self.familyPlans, "et")
        self.familyPlans_gl = language_translate(self.familyPlans_gl, self.familyPlans, "gl")
        self.familyPlans_ka = language_translate(self.familyPlans_ka, self.familyPlans, "ka")
        self.familyPlans_hi = language_translate(self.familyPlans_hi, self.familyPlans, "hi")
        self.familyPlans_hu = language_translate(self.familyPlans_hu, self.familyPlans, "hu")
        self.familyPlans_is = language_translate(self.familyPlans_is, self.familyPlans, "is")
        self.familyPlans_id = language_translate(self.familyPlans_id, self.familyPlans, "id")
        self.familyPlans_ga = language_translate(self.familyPlans_ga, self.familyPlans, "ga")
        self.familyPlans_mk = language_translate(self.familyPlans_mk, self.familyPlans, "mk")
        self.familyPlans_mn = language_translate(self.familyPlans_mn, self.familyPlans, "mn")
        self.familyPlans_ne = language_translate(self.familyPlans_ne, self.familyPlans, "ne")
        self.familyPlans_ro = language_translate(self.familyPlans_ro, self.familyPlans, "ro")
        self.familyPlans_sr = language_translate(self.familyPlans_sr, self.familyPlans, "sr")
        self.familyPlans_sk = language_translate(self.familyPlans_sk, self.familyPlans, "sk")
        self.familyPlans_ta = language_translate(self.familyPlans_ta, self.familyPlans, "ta")
        self.familyPlans_tg = language_translate(self.familyPlans_tg, self.familyPlans, "tg")
        self.familyPlans_tr = language_translate(self.familyPlans_tr, self.familyPlans, "tr")
        self.familyPlans_ur = language_translate(self.familyPlans_ur, self.familyPlans, "ur")
        self.familyPlans_uz = language_translate(self.familyPlans_uz, self.familyPlans, "uz")
...
class politics(models.Model):
    ...
    politics_es_419 = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    politics_br = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    politics_nn = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    def save(self, *args, **kwargs):
        ...
        self.politics_zh_cn = language_translate(self.politics_zh_cn, self.politics, "zh-cn")
        ...
        self.politics_pt_br = language_translate(self.politics_pt_br, self.politics, "pt_br")
        self.politics_pt_pt = language_translate(self.politics_pt_pt, self.politics, "pt_pt")
        ...
        self.politics_zh_tw = language_translate(self.politics_zh_tw, self.politics, "zh-tw")
...
class religious(models.Model):
    ...
    religious_es_419 = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    religious_br = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    religious_nn = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    def save(self, *args, **kwargs):
        ...
        self.religious_zh_cn = language_translate(self.religious_zh_cn, self.religious, "zh-cn")
        ...
        self.religious_pt_br = language_translate(self.religious_pt_br, self.religious, "pt_br")
        self.religious_pt_pt = language_translate(self.religious_pt_pt, self.religious, "pt_pt")
        ...
        self.religious_zh_tw = language_translate(self.religious_zh_tw, self.religious, "zh-tw")
...
class tags(models.Model):
    ...
    tag_es_419 = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    tag_br = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    tag_pl = models.CharField(max_length=265, null=True, blank=True)
    tag_vi = models.CharField(max_length=265, null=True, blank=True)
    tag_nn = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
...
class zodiacSign(models.Model):
    ...
    zodiacSign_es_419 = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    zodiacSign_br = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    zodiacSign_nn = models.CharField(max_length=265, null=True, blank=True) # manually translate due to unavailability in google
    ...
    def save(self, *args, **kwargs):
        self.zodiacSign_fr = language_translate(self.zodiacSign_fr, self.zodiacSign, "fr")
        self.zodiacSign_zh_cn = language_translate(self.zodiacSign_zh_cn, self.zodiacSign, "zh-cn")
        self.zodiacSign_nl = language_translate(self.zodiacSign_nl, self.zodiacSign, "nl")
        self.zodiacSign_de = language_translate(self.zodiacSign_de, self.zodiacSign, "de")
        self.zodiacSign_sw = language_translate(self.zodiacSign_sw, self.zodiacSign, "sw")
        self.zodiacSign_it = language_translate(self.zodiacSign_it, self.zodiacSign, "it")
        self.zodiacSign_ar = language_translate(self.zodiacSign_ar, self.zodiacSign, "ar")
        self.zodiacSign_iw = language_translate(self.zodiacSign_iw, self.zodiacSign, "iw")
        self.zodiacSign_ja = language_translate(self.zodiacSign_ja, self.zodiacSign, "ja")
        self.zodiacSign_ru = language_translate(self.zodiacSign_ru, self.zodiacSign, "ru")
        self.zodiacSign_fa = language_translate(self.zodiacSign_fa, self.zodiacSign, "fa")
        self.zodiacSign_pt_br = language_translate(self.zodiacSign_pt_br, self.zodiacSign, "pt_br")
        self.zodiacSign_pt_pt = language_translate(self.zodiacSign_pt_pt, self.zodiacSign, "pt_pt")
        self.zodiacSign_es = language_translate(self.zodiacSign_es, self.zodiacSign, "es")
        self.zodiacSign_el = language_translate(self.zodiacSign_el, self.zodiacSign, "el")
        self.zodiacSign_zh_tw = language_translate(self.zodiacSign_zh_tw, self.zodiacSign, "zh-tw")
        self.zodiacSign_uk = language_translate(self.zodiacSign_uk, self.zodiacSign, "uk")
        self.zodiacSign_ko = language_translate(self.zodiacSign_ko, self.zodiacSign, "ko")
        self.zodiacSign_pl = language_translate(self.zodiacSign_pl, self.zodiacSign, "pl")
        self.zodiacSign_vi = language_translate(self.zodiacSign_vi, self.zodiacSign, "vi")
        self.zodiacSign_no = language_translate(self.zodiacSign_no, self.zodiacSign, "no")
        self.zodiacSign_sv = language_translate(self.zodiacSign_sv, self.zodiacSign, "sv")
        self.zodiacSign_hr = language_translate(self.zodiacSign_hr, self.zodiacSign, "hr")
        self.zodiacSign_cs = language_translate(self.zodiacSign_cs, self.zodiacSign, "cs")
        self.zodiacSign_da = language_translate(self.zodiacSign_da, self.zodiacSign, "da")
        self.zodiacSign_tl = language_translate(self.zodiacSign_tl, self.zodiacSign, "tl")
        self.zodiacSign_fi = language_translate(self.zodiacSign_fi, self.zodiacSign, "fi")
        self.zodiacSign_sl = language_translate(self.zodiacSign_sl, self.zodiacSign, "sl")
        self.zodiacSign_sq = language_translate(self.zodiacSign_sq, self.zodiacSign, "sq")
        self.zodiacSign_am = language_translate(self.zodiacSign_am, self.zodiacSign, "am")
        self.zodiacSign_hy = language_translate(self.zodiacSign_hy, self.zodiacSign, "hy")
        self.zodiacSign_la = language_translate(self.zodiacSign_la, self.zodiacSign, "la")
        self.zodiacSign_lv = language_translate(self.zodiacSign_lv, self.zodiacSign, "lv")
        self.zodiacSign_th = language_translate(self.zodiacSign_th, self.zodiacSign, "th")
        self.zodiacSign_az = language_translate(self.zodiacSign_az, self.zodiacSign, "az")
        self.zodiacSign_eu = language_translate(self.zodiacSign_eu, self.zodiacSign, "eu")
        self.zodiacSign_be = language_translate(self.zodiacSign_be, self.zodiacSign, "be")
        self.zodiacSign_bn = language_translate(self.zodiacSign_bn, self.zodiacSign, "bn")
        self.zodiacSign_bs = language_translate(self.zodiacSign_bs, self.zodiacSign, "bs")
        self.zodiacSign_bg = language_translate(self.zodiacSign_bg, self.zodiacSign, "bg")
        self.zodiacSign_km = language_translate(self.zodiacSign_km, self.zodiacSign, "km")
        self.zodiacSign_ca = language_translate(self.zodiacSign_ca, self.zodiacSign, "ca")
        self.zodiacSign_et = language_translate(self.zodiacSign_et, self.zodiacSign, "et")
        self.zodiacSign_gl = language_translate(self.zodiacSign_gl, self.zodiacSign, "gl")
        self.zodiacSign_ka = language_translate(self.zodiacSign_ka, self.zodiacSign, "ka")
        self.zodiacSign_hi = language_translate(self.zodiacSign_hi, self.zodiacSign, "hi")
        self.zodiacSign_hu = language_translate(self.zodiacSign_hu, self.zodiacSign, "hu")
        self.zodiacSign_is = language_translate(self.zodiacSign_is, self.zodiacSign, "is")
        self.zodiacSign_id = language_translate(self.zodiacSign_id, self.zodiacSign, "id")
        self.zodiacSign_ga = language_translate(self.zodiacSign_ga, self.zodiacSign, "ga")
        self.zodiacSign_mk = language_translate(self.zodiacSign_mk, self.zodiacSign, "mk")
        self.zodiacSign_mn = language_translate(self.zodiacSign_mn, self.zodiacSign, "mn")
        self.zodiacSign_ne = language_translate(self.zodiacSign_ne, self.zodiacSign, "ne")
        self.zodiacSign_ro = language_translate(self.zodiacSign_ro, self.zodiacSign, "ro")
        self.zodiacSign_sr = language_translate(self.zodiacSign_sr, self.zodiacSign, "sr")
        self.zodiacSign_sk = language_translate(self.zodiacSign_sk, self.zodiacSign, "sk")
        self.zodiacSign_ta = language_translate(self.zodiacSign_ta, self.zodiacSign, "ta")
        self.zodiacSign_tg = language_translate(self.zodiacSign_tg, self.zodiacSign, "tg")
        self.zodiacSign_tr = language_translate(self.zodiacSign_tr, self.zodiacSign, "tr")
        self.zodiacSign_ur = language_translate(self.zodiacSign_ur, self.zodiacSign, "ur")
        self.zodiacSign_uz = language_translate(self.zodiacSign_uz, self.zodiacSign, "uz")
